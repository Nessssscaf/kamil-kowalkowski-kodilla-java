...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://nessssscaf.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("k.kowalkowski@yahoo.pl");
        driverTrello.findElement(By.id("password")).sendKeys("m-y7gjXP6g.Sm:6");
